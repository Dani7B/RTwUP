...
class DictionaryValueComparator implements Comparator<DomainPageCouple>, Serializable {

    private static final long serialVersionUID = -957185463199492908L;

    private final Map<DomainPageCouple, Integer> base;
