package it.cybion.monitoring.rtwup.storm.spouts;
...
public class TwitterSpout extends BaseRichSpout {
    ...
    private static final long serialVersionUID = -4818591433454375358L;
	...
	public void declareOutputFields(OutputFieldsDeclarer declarer) {
		declarer.declare(new Fields(it.cybion.monitoring.rtwup.storm.bolts.Fields.STATUS_JSON));
	}
