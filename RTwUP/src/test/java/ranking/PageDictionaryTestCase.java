...
public class PageDictionaryTestCase {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(PageDictionaryTestCase.class);
	...
	public void shouldAddToDictionary(){
		int count1 = this.counts.addToDictionary("youtube.com", "http://youtube.com/123");
		LOGGER.info("Counts: "+ count1);
		assertEquals(count1, 1);
		int count2 = this.counts.addToDictionary("youtube.com", "http://youtube.com/123");
